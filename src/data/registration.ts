...
> = {
  client: {
    title: 'Клиент',
    subtitle: 'Заказ поездок и профиль пассажира.',
    submitLabel: 'Создать аккаунт клиента',
    reviewStatus: 'Подтвердите телефон и почту',
  },
  self_employed_driver: {
    title: 'Водитель',
    subtitle: 'Заказы, оплата напрямую, день или Партнёр PRO.',
    submitLabel: 'Отправить заявку водителя',
    reviewStatus: 'После проверки документов откроется лента заказов.',
  },
  park_admin: {
    title: 'Таксопарк',
    subtitle: 'Только ИП: водители, авто, заказы и сверка.',
    submitLabel: 'Зарегистрировать таксопарк',
    reviewStatus: 'Проверим ИП, ОГРНИП и расчётный счёт',
  },
  park_driver: {
    title: 'Водитель таксопарка',
    subtitle: 'Работа по приглашению парка с быстрой привязкой.',
    submitLabel: 'Присоединиться к таксопарку',
    reviewStatus: 'Доступ — после активации парком и проверки',
  },
  driver: {
    title: 'Водитель',
  ...
  fleet: {
    title: 'Таксопарк',
    subtitle: 'Водители, автомобили и выплаты парка.',
    submitLabel: 'Отправить заявку автопарка',
    reviewStatus: 'Проверим юридические данные',
  },
};
...
const commonFields: RegistrationField[] = [
  ...
  },
  {
    ...
    helper: 'Подтвердим кодом или ссылкой. Пароль от почты не нужен.',
  },
  {
    id: 'appPassword',
  ...
  },
  {
    ...
    helper: 'Код закрепит бонусы за вами и пригласившим.',
  },
];
...
const driverFields: RegistrationField[] = [
  ...
  },
  {
    ...
    required: true,
    keyboardType: 'number-pad',
    helper: 'Нужен для анкеты и сверки расчётов.',
  },
  {
    id: 'driverLicense',
  ...
  },
  {
    ...
    placeholder: 'Клиент платит мне напрямую, долю сервиса перевожу в конце дня',
    section: 'legal',
    required: true,
    helper: 'Платёжных систем в пилоте нет — сумму к переводу считает приложение.',
  },
  {
  ...
  },
  {
    ...
    placeholder: 'Готов предоставить СТС и документы авто',
    section: 'vehicle',
    required: true,
    helper: 'Проверка проходит вручную до открытия заказов.',
  },
  {
    id: 'payoutAccount',
...
const parkDriverFields: RegistrationField[] = [
  ...
  },
  {
    ...
    section: 'legal',
    required: true,
    helper: 'Парк добавляет водителя по коду и открывает заказы.',
  },
];
...
export const consentItems = [
  ...
  },
  {
    ...
    text: 'Согласен с правилами сервиса и перевозки.',
  },
] as const;
...
export const verificationSteps: Record<AccountRole, string[]> = {
  ...
  self_employed_driver: [
    ...
    'Дневной доступ 100 ₽ за 24 часа',
    'Проверка автомобиля, СТС, ОСАГО и ОСГОП',
    'Выбор: день 100 ₽ или Партнёр PRO 2 490 ₽/мес',
  ],
  park_admin: [
    'Проверка контакта',
