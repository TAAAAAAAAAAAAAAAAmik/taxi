export const kinetixColors = {
  ...
  amberPressed: "#006F3A",
  amberBright: "#40C878",
  amberSoft: "rgba(0, 141, 73, 0.12)",
  lime: "#B7F46A",
  limeSoft: "rgba(183, 244, 106, 0.22)",
  teal: "#006BB6",
  tealSoft: "rgba(0, 107, 182, 0.12)",
  mapBase: "#DDECE3",
  mapRoad: "rgba(255, 255, 255, 0.78)",
  mapRoute: "#00A855",
  safety: "#0B6B4A",
  glass: "rgba(255, 255, 255, 0.88)",
  glassStrong: "rgba(255, 255, 255, 0.96)",
  line: "rgba(18, 56, 44, 0.12)",
  lineStrong: "#008D49",
  success: "#008D49",
  warning: "#E7B416",
  danger: "#FF3B30",
